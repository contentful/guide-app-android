 ...
 * <p/>
 * 2. Inflated and displayed by {@link InfoActivity}, representing a single {@code Place} over the
 * map.
 */
public class GuideMapFragment extends SupportMapFragment
  ...
  private void showMarkers() {
    ...
    if (b != null) {
      place = (Place) b.getSerializable(InfoActivity.EXTRA_PLACE);
    }
  ...
  private Marker addMarker(Place place) {
    ...
    return getMap().addMarker(new MarkerOptions().position(position).title(place.getName()));
  }
